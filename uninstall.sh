...
main() {
    ...
    # Remove config/history state. Field-level handling for history.db and
    # release backups colocated with config.toml lives in
    # remove_state_directories (KeepConfig/KeepHistory interact).
